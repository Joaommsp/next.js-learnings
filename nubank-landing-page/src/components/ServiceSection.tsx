    ...
    <section className="flex flex-col items-center py-4">
      ...
      <Container>
        <div className="flex items-center w-full justify-between">
          <div className="flex-1 max-w-[594px] py-28">
            <span className="block text-primary-purple text-sm font-medium uppercase mb-9 ">
              Serviços exclusivos
            </span>
            <h1 className="text-4xl text-primary-gray font-semibold leading-tight mb-8">
              Gerencia suas finanças sem sair de casa
            </h1>
            <p className="text-sm max-w-[554px] mb-16 text-second-gray">
